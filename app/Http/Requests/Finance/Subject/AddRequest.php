...
namespace App\Http\Requests\Finance\Subject;
...
class AddRequest extends BaseRequest
{
    public function rules(Request $request): array
    {
        ...
        return [
            ...
            'abb'             => 'sometimes|between:2,32',
            'cn_name'         => 'required|between:2,32',
            'en_name'         => 'sometimes|between:2,32',
            ...
            'is_foreign'      => 'required|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'is_dn'           => 'required|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'is_frozen'       => 'required|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'is_last'         => 'required|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'is_cash'         => 'required|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'vendor_required' => 'sometimes|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'clerk_required'  => 'sometimes|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'team_required'   => 'sometimes|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
            'branch_required' => 'sometimes|in:' . GlobalConstant::enums(GlobalConstant::YES_NO),
        ];
    }
