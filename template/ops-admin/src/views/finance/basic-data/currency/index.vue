...
import { fetchDel, fetchGetList } from '@/service/api/finance/currency';
...
const {
  ...
  columns: () => [
    ...
    {
      key: 'code',
      title: $t('page.finance.currency.code'),
      align: 'center',
      minWidth: 100
    },
    {
      key: 'cn_name',
      title: $t('page.finance.currency.cn_name'),
      align: 'center',
      width: 100
    },
    {
      key: 'en_name',
      title: $t('page.finance.currency.en_name'),
      align: 'center',
      minWidth: 100,
      ellipsis: {
        tooltip: true
    ...
    {
      key: 'symbol',
      title: $t('page.finance.currency.symbol'),
      align: 'center',
      minWidth: 30
    },
    {
      key: 'is_enable',
      title: $t('page.finance.currency.is_enable'),
      align: 'center',
      minWidth: 100,
      render: row => {
