...
INSERT INTO `ops`.`generate_records` (`id`, `table_name`, `controller`, `logic`, `add_request`, `update_request`, `index_vue`, `api_type`, `search_form`, `operate_drawer`, `lang_zh`, `service_api`, `created_at`, `updated_at`) VALUES (11, 'generate_records', '\\app\\Http\\Controllers\\Tool\\GenerateRecordController.php', '\\app\\Logics\\Tool\\GenerateRecordLogic.php', '\\app\\Http\\Requests\\Tool\\GenerateRecord\\AddRequest.php', '\\app\\Http\\Requests\\Tool\\GenerateRecord\\UpdateRequest.php', '/template/ops-admin/src/views/setting/tool/generate-record/index.vue', '/template/ops-admin/src/typings/tool.d.ts', '/template/ops-admin/src/views/setting/tool/generate-record/modules/search-form.vue', '/template/ops-admin/src/views/setting/tool/generate-record/modules/operate-drawer.vue', '/template/ops-admin/src/locales/langs/zh/tool.ts', '/template/ops-admin/src/service/api/tool/generate_record.ts', '2024-10-30 19:43:09', '2024-10-30 19:43:09');
INSERT INTO `ops`.`generate_records` (`id`, `table_name`, `controller`, `logic`, `add_request`, `update_request`, `index_vue`, `api_type`, `search_form`, `operate_drawer`, `lang_zh`, `service_api`, `created_at`, `updated_at`) VALUES (13, 'fin_cost_items', '\\app\\Http\\Controllers\\Finance\\CostItemController.php', '\\app\\Logics\\Finance\\CostItemLogic.php', '\\app\\Http\\Requests\\Finance\\CostItem\\AddRequest.php', '\\app\\Http\\Requests\\Finance\\CostItem\\UpdateRequest.php', '/template/ops-admin/src/views/finance/basic-data/cost-item/index.vue', '/template/ops-admin/src/typings/finance.d.ts', '/template/ops-admin/src/views/finance/basic-data/cost-item/modules/search-form.vue', '/template/ops-admin/src/views/finance/basic-data/cost-item/modules/operate-drawer.vue', '/template/ops-admin/src/locales/langs/zh/finance.ts', '/template/ops-admin/src/service/api/finance/cost_item.ts', '2024-10-30 19:55:32', '2024-10-30 19:55:32');
