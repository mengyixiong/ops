...
INSERT INTO `ops`.`system_menus` (`id`, `pid`, `title`, `sort`, `i18n_key`, `is_hide_menu`, `name`, `path`, `component`, `icon`, `com_id`, `permission`, `type`, `deleted_at`, `created_at`, `updated_at`) VALUES (24, 0, '设置', NULL, NULL, 'N', 'setting', '/setting', 'view.setting', 'ant-design:setting-filled', '[]', '', '1', NULL, '2024-08-21 07:30:30', '2024-08-21 07:30:30');
